...
import { BookOpen, Key, Mail, User, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#121212] flex items-center justify-center p-6 text-white font-sans">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-500 text-xs mt-1">Buat akun untuk memulai membaca gratis.</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-zinc-500 text-xs">
            Sudah punya akun?{" "}
            <Link href="/login" className="text-purple-400 hover:underline hover:text-purple-300 font-semibold transition-colors duration-300">
              Masuk Sini
            </Link>
          </p>
        </div>
